...
import UserProfilePicture from '@/modules/shared/components/UserProfilePicture.vue'
...
<template>
    <section class="post">
        ...
        <section class="content-background">
            ...
            <ViewVideo v-else-if="post.mediaType === MediaType.VIDEO" :post="post"
        ...
        <div class="data">
            ...
            <section class="votes">
                <p class="views">
                    <span>{{ formatNumber(post.meta.views) }}</span> Views
                </p>
                <p class="likes">
                    <span>{{ formatNumber(voting?.likeData.likes ?? 0) }}</span>
                    <LikeIcon :class="{ active: voting?.likeData.myVote === 1 }" class="like"
                        @click="voting?.vote(1)" />
                </p>
                <p class="dislikes">
