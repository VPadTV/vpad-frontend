...
import type { PostCreateBody, PostGetManyBody, UpdatePostBody, PostGetResponse } from "./post.types"
...
export abstract class PostRepository {
    ...
    static getMany = (body: PostGetManyBody) => callAPI<Paginate<PostGetResponse>>(BASE, HTTP.GET, body)
